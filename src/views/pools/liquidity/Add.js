...
const Add = (props) => {
    ...
    async function addLiquidity() {
        ...
        contract.connect(signer).addLiquidity(
            ...
            ethers.utils.parseUnits(crypto1.decimal == 6 ? formData.amountADesired.toFixed(6) : formData.amountADesired.toString(), crypto1.decimal),
            ethers.utils.parseUnits(crypto2.decimal == 6 ? formData.amountBDesired.toFixed(6) : formData.amountBDesired.toString(), crypto2.decimal),
            0,
            0,
            accounts[0],
            deadline,
